    ...
    <section class="section">
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            <img src="<?php echo e(asset("assets/img/stisla-fill.svg")); ?>" alt="logo" width="80" class="shadow-light rounded-circle mb-5 mt-2">
...
<?php /**PATH /home/zaenal-ar/Project/absen/resources/views/auth/login.blade.php ENDPATH**/ ?>